...
$target_stage = $_POST['target'];
$currentStage = $_POST['currentStage'];
$targetStage = $_POST['targetStage'];
...
if (mysqli_query($con, $q)) {
    ...
    $ActivitySent = "The Stage of Sub-task $subtaskname has been changed to $targetStage from $currentStage by $createrName!";
