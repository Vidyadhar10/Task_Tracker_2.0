...
<body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="pt-4 mb-4 mb-lg-3 pb-lg-4 profile-wrapper">
                        <div class="row g-4">
                            ...
                            <div class="col">
                                <div class="p-2">
                                    <h3 class="text-white mb-1" id="EmployeeName"></h3>
                                    <p class="text-white-75" id="EmployeeDesignation"></p>
                                    <div class="hstack text-white-50 gap-1">
                                        <div class="me-2"><i class="ri-map-pin-user-line me-1 text-white-75 fs-16 align-middle"></i><span id="EmployeeAddress"></span></div>
                                        <!-- <div>
    ...
    <script>
        ...
        function ShowEmployeeData() {
            $.ajax({
                url: 'assets/php/GetEmployeeData.php',
                type: 'POST',
                dataType: 'JSON',
                data: {
                    empid: empid,
